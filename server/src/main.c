...
//    env.tracer = trace;
    ...
    ret_val = dc_application_run(&env, &err, info, create_settings, destroy_settings, run, create_application_lifecycle, destroy_application_lifecycle, "~/.dcecho.conf", argc, argv);
